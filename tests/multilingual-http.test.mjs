...
assert.equal(routes.length,540);assert.equal(new Set(routes).size,540);
...
console.log('multilingual-http: 540/540 URLs base HTTP 200 y scripts 15 idiomas válidos');
