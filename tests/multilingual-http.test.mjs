...
assert.equal(routes.length,555);assert.equal(new Set(routes).size,555);
...
console.log('multilingual-http: 555/555 URLs base HTTP 200 y scripts 15 idiomas válidos');
