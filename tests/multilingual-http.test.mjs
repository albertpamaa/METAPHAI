...
assert.equal(routes.length,525);assert.equal(new Set(routes).size,525);
...
console.log('multilingual-http: 525/525 URLs base HTTP 200 y scripts 15 idiomas válidos');
