...
assert.equal(routes.length,495);assert.equal(new Set(routes).size,495);
...
console.log('multilingual-http: 495/495 URLs base HTTP 200 y scripts 15 idiomas válidos');
