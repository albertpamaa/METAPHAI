...
for(const file of htmlFiles){
  ...
  assert.match(html,/data\.css\?v=20260912-4/);
...
for(const file of interactive){
  const html=readFileSync(file,'utf8');
  assert.match(html,/data-explorer\.js\?v=20260912-4/);
...
assert.match(explorer,/mobile\?\{l:76,r:16,t:34,b:44\}:\{l:64,r:24,t:32,b:44\}/);
